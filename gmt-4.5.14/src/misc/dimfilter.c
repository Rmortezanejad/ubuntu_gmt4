/*--------------------------------------------------------------------
 * $Id: dimfilter.c 10289 2014-12-28 21:17:06Z pwessel $
 *
 *	Copyright (c) 2009-2015 by P. Wessel and Seung-Sep Kim
...
int main (int argc, char **argv)
{
	...
	GMT_LONG nx_out, ny_out, nx_fil, ny_fil, *n_in_median = NULL, n_nan = 0;
	...
	double x_out, y_out, *wt_sum = NULL, *value = NULL, last_median, this_median, last_median2 = 0.0, this_median2, xincnew2, yincnew2;
