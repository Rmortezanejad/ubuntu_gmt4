 ...
 */
		...
		fprintf (stderr, "	DEG2KM	1 1	Converts Spherical Degrees to Kilometers.\n");
		...
		fprintf (stderr, "	KM2DEG	1 1	Converts Kilometers to Spherical Degrees.\n");
		...
		fprintf (stderr, "	SDIST	2 1	Spherical (Great circle|geodesic) distance (in km) between grid nodes and stack lon,lat (A, B).\n");
