/*---------------------------------------------------------------------------
 *	$Id: mgd77_init.h 10289 2014-12-28 21:17:06Z pwessel $
 *
...
GMT_LONG MGD77_format_allowed[MGD77_N_FORMATS] = {TRUE, TRUE, TRUE, TRUE};	/* By default we allow opening of files in any format.  See MGD77_Ignore_Format() */
