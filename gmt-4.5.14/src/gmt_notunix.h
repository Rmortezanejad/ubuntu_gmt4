/*--------------------------------------------------------------------
 *	$Id: gmt_notunix.h 10289 2014-12-28 21:17:06Z pwessel $
 *
 ...
 * FLOCK is buggy on UNIX and it cannot be used under WIN32.
 * Some ancient NFS clients do not support it. However, it
 * should be safe to activate -DFLOCK.
 */
...
#ifndef isnan		/* VC12 defines isnan */
...
#undef FLOCK		/* Do not enable file locking */
