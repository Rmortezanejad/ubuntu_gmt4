/*	$Id: gshhg.h 10291 2014-12-30 20:42:19Z pwessel $
 *
 ...
 *
 * Note: Antarctica shorelines/islands come in two flavors: Grounding Line or IceFront Line.  These are both
 * present in the database but given levels of 5 and 6 respectively, to uniquely identify them.  Developers
 * should decide (or have their users decide via an option) which flavor to use.  For further processing these
 * polygons should be thought of as level = 1 like any other shoreline.
 */
